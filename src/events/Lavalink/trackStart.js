...
module.exports = async (client, player, track, payload) => {
  ...
  const thing = new MessageEmbed()
    .setDescription(`${i18n.__("cmd.play.embed")}\n [${track.title}](https://discord.gg/9V9PfjzpqE) - \`[${convertTime(track.duration)}]\``)
